...
private:
    ...
    const int VEL_GIRO = 255;                // Reducción de velocidad al girar
    const int VEL_CRUCERO = 255;             // Velocidad crucero
    const int VEL_GIRO_CRUCERO = 255;        // Velocidad giro en crucero
